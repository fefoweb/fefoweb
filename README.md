...
- 🔭 I’m currently working with 🏠 @Immobiliare, in the Software Development Team (in @ImmobiliareLabs), with a focus on developing and maintaining web applications through the use of server-side and client-side technologies.
- 🌱 I’m currently improving my knowledge about react.js, next.js
- 😄 Pronouns: Fefo (my sister call me with `fefo`), fefoweb on Web
